import os from 'os'
import macMToolsNative from '../../../../resources/lib/mac/ztools_native.node?asset'
import winMToolsNative from '../../../../resources/lib/win/ztools_native.node?asset'

// 根据平台加载对应的原生模块
const platform = os.platform()
// eslint-disable-next-line @typescript-eslint/no-require-imports
const addon = require(platform === 'darwin' ? macMToolsNative : winMToolsNative)
