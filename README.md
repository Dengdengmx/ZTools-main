...
<div align="center">
  <img src="./.github/assets/demo.gif" alt="MTools 演示" width="600">
...
从 [Releases](https://github.com/MToolsCenter/MTools/releases) 页面下载最新版本：

- **macOS**: `ztools-x.x.x.dmg` 或 `MTools-x.x.x-arm64-mac.zip`
...
- 插件托管在 GitHub Releases（[MTools-plugins](https://github.com/MToolsCenter/MTools-plugins/releases)）
...
- 更新源：GitHub Releases（[MTools](https://github.com/MToolsCenter/MTools/releases)）
...
MTools 是一个强大、可扩展的插件平台，使用自定义插件提升您的生产力。通过简单的配置、丰富的 API 以及跨平台支持，您可以轻松开发出功能强大的插件。
...
> 📖 **完整文档**：查看 [MTools 开发者文档](https://ztoolscenter.github.io/MTools-doc/) 了解更多详情

MTools 提供完整的插件系统，支持两种类型：
...
- 如果需要贡献代码请 fork [ztools-api-types](https://github.com/MToolsCenter/ztools-api-types) 和 [ztools-plugin-cli](https://github.com/MToolsCenter/ztools-plugin-cli) 仓库

2. 拉取完整代码

```bash
git clone https://github.com/MToolsCenter/MTools.git --recurse-submodules
```
...
遇到问题？请在 [Issues](https://github.com/MToolsCenter/MTools/issues) 中反馈。
...
如果 MTools 对你有帮助，欢迎通过爱发电赞助支持项目的持续开发：
