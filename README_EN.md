...
<img src="./.github/assets/icon.png" alt="MTools Logo" width="120">
...
[![GitHub release](https://img.shields.io/github/v/release/lzx8589561/MTools)](https://github.com/MToolsCenter/MTools/releases)
[![License](https://img.shields.io/github/license/lzx8589561/MTools)](./LICENSE)
[![Platform](https://img.shields.io/badge/platform-macOS%20%7C%20Windows-blue)](https://github.com/MToolsCenter/MTools)
...
<div align="center">
  <img src="./.github/assets/demo.gif" alt="MTools Demo" width="600">
...
Download the latest version from [Releases](https://github.com/MToolsCenter/MTools/releases):

- **macOS**: `ztools-x.x.x.dmg` or `MTools-x.x.x-arm64-mac.zip`
...
git clone https://github.com/MToolsCenter/MTools.git
cd MTools
...
MTools provides a built-in plugin market for easy browsing and installation:
...
1. Open MTools settings (click avatar)
...
- Plugins hosted on GitHub Releases ([MTools-plugins](https://github.com/MToolsCenter/MTools-plugins/releases))
...
MTools supports one-click in-app updates without manual download:
...
- Update source: GitHub Releases ([MTools](https://github.com/MToolsCenter/MTools/releases))
...
MTools is a powerful and extensible plugin platform that enhances your productivity with custom plugins. With simple configuration, rich APIs, and cross-platform support, you can easily develop powerful plugins.
...
> 📖 **Full Documentation**: Visit [MTools Developer Documentation](https://ztoolscenter.github.io/MTools-doc/) for more details

MTools provides a complete plugin system supporting two types:
...
Having issues? Please report them in [Issues](https://github.com/MToolsCenter/MTools/issues).
...
If MTools has been helpful to you, consider sponsoring the project on Afdian to support continued development:

<a href="https://afdian.com/a/MTools">
...
[![Star History Chart](https://api.star-history.com/svg?repos=lzx8589561/MTools&type=Date)](https://star-history.com/#lzx8589561/MTools&Date)
